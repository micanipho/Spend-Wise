...
using SpendWise.Models.TokenAuth;
...
public abstract class SpendWiseWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static SpendWiseWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(SpendWiseWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<SpendWiseDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<SpendWiseDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<SpendWiseDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<SpendWiseDbContext, Task<T>> func)
    {
        T result;
